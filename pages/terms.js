    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={2} headerCls="navbar-dark">
                <div>
                    <section id="terms-page" className="page-hero-section division">
                        <div className="container">
                            <div className="row">
                                <div className="col-md-10 col-lg-8 offset-md-1 offset-lg-2">
                                    <div className="hero-txt text-center white-color">
                                        <h3 className="h3-xl">Our Terms &amp; Privacy</h3>
                                ...
                                <div className="col-md-8">
                                    <div className="terms-box">
                                        <div className="terms-title">
                                            <p className="grey-color">Last Updated: April 26, 2023</p>
                                            <p className="p-notice">PLEASE READ THESE TERMS AND CONDITIONS (THE ‘AGREEMENT’) IN THEIR ENTIRETY
                                                BEFORE USING OR RECEIVING ANY FEATURES (AS DEFINED BELOW) FROM TebSocial, INC. (THE ‘COMPANY’).
                                            </p>
                                        ...
                                        <ul className="terms-list">
                                            ...
                                            <li>Morbi dui lectus, lobortis sit amet felis nec, suscipit imperdiet sapien. Proin semper ultrices ex, a
                                                sodales purus vehicula. Nunc gravida ultrices felis eget faucibus. Praesent aliquet
                                            </li>
                                        </ul>
                                        <p className="p-notice">IF YOU DO NOT AGREE TO THE TERMS OF THIS AGREEMENT OR CANNOT MAKE ANY OF THE FOREGOING REPRESENTATIONS,
                                    ...
                                    <div className="terms-box">
                                        <h5 className="h5-xl">1. Eligibility</h5>
                                        <p>Donec sodales, nibh vel tristique aliquet, nisi libero suscipit diam, sed tempus ante nulla ut purus.
                                            Donec dolor magna, suscipit in magna dignissim, porttitor hendrerit. Nunc gravida ultrices felis
                                            eget faucibus. Praesent aliquet lorem purus, quis mollis nisi laoreet vitae. Mauris nec consequat tortor
                                        </p>
                                        <ul className="terms-list">
                                            ...
                                            <li>Morbi dui lectus, lobortis sit amet felis nec, suscipit imperdiet sapien. Proin semper ultrices ex, a
                                                sodales purus vehicula gravida ultrices felis eget faucibus praesent aliquet
                                            </li>
                                            <li>Nulla tincidunt volutpat tincidunt habitant morbi tristique senectus et netus et malesa fames</li>
                                        </ul>
                                    </div>
                                    <div className="terms-box">
                                        <h5 className="h5-xl">2. Collection of Information</h5>
                                    ...
                                    <div className="terms-box">
                                        <h5 className="h5-xl">3. Authorized User Accounts and Account Security</h5>
                                    ...
                                    <div className="terms-box">
                                        <h5 className="h5-xl">4. Prohibited Conduct and Content</h5>
                                        <p>Donec sodales, nibh vel tristique aliquet, nisi libero suscipit diam, sed tempus ante nulla ut purus.
                                            Donec dolor magna, suscipit in magna dignissim, porttitor hendrerit diam. Nunc gravida ultrices felis
                                        </p>
                                    </div>
                                    <div className="terms-box">
                                        <h5 className="h5-xl">5. Your Responsibilities</h5>
                                        <p>Donec sodales, nibh vel tristique aliquet, nisi libero suscipit diam, sed tempus ante nulla ut purus.
                                            Donec dolor magna, suscipit in magna dignissim, porttitor hendrerit diam. Nunc gravida ultrices felis
                                        </p>
                                        <ul className="terms-list">
                                            <li>Donec dolor magna, suscipit in magna dignissim, porttitor hendrerit diam. Nunc gravida ultrices felis
                                                eget faucibus. Praesent aliquet tempus, blandit posuere ligula varius congue cursus
                                            </li>
                                            <li>Aliquam varius neque commodo purus vulputate pharetra bibendum in ante ornare metus</li>
                                            <li>Morbi dui lectus, lobortis sit amet felis nec, suscipit imperdiet sapien semper ultrices</li>
                                            <li>Nulla tincidunt volutpat tincidunt. Pellentesque habitant morbi tristique senectus et netus et
                                    ...
                                    <div className="terms-box">
                                        <h5 className="h5-xl">6. Availability Of Services</h5>
                                        <p><span>6.1 General Availability</span> Donec sodales, nibh vel tristique aliquet, nisi libero suscipit diam,
                                            sed tempus ante nulla ut purus. Donec dolor magna, suscipit in magna dignissim, porttitor hendrerit diam
                                        </p>
                                    ...
                                    <div className="terms-box">
                                        <h5 className="h5-xl">7. Prohibited Conduct and Content</h5>
                                        <p>Donec sodales, nibh vel tristique aliquet, nisi libero suscipit diam, sed tempus ante nulla ut purus.
                                            Donec dolor magna, suscipit in magna dignissim, porttitor hendrerit diam. Nunc gravida ultrices felis
                                        </p>
                                    </div>
                                    <div className="terms-box">
                                        <h5 className="h5-xl">8. Warranty Limitations</h5>
                                        <p>Ut non mauris libero. Sed consequat posuere nunc, eu porttitor neque dignissim nec. Donec
                                            bibendum sodales elit eu blandit. Suspendisse at finibus metus. Integer nulla quam, pulvinar
                                            fermentum commodo nec, pulvinar sed nisi. Sed augue turpis, mollis a vehicula ornare, dapibus
                                        </p>
                                        <p>Sed eu ex quis leo ultrices aliquet. Curabitur mauris orci, imperdiet eu dui quis, ulvinar
                                            feugiat orci. Curabitur at ex quis ipsum volutpat vehicula id in ante. Proin in tortor nec
                                            risus interdum tincidunt eget
                                        </p>
                                    </div>
                                    <div className="terms-box">
                                        <h5 className="h5-xl">9. Notices</h5>
                                        <p>Donec sodales, nibh vel tristique aliquet, nisi libero suscipit diam, sed tempus ante nulla ut purus.
                                            Donec dolor magna, suscipit in magna dignissim, porttitor hendrerit diam. Nunc gravida ultrices felis
                                        </p>
                                    ...
                                    <div className="terms-box">
                                        <h5 className="h5-xl">10. Third Party Beneficiary</h5>
                                        <p>Donec sodales, nibh vel tristique aliquet, nisi libero suscipit diam, sed tempus ante nulla ut purus.
                                            Donec dolor magna, suscipit in magna dignissim, porttitor hendrerit diam. Nunc gravida ultrices felis
                                        </p>
                                        <p>Quisque eleifend arcu ac tellus cursus, nec vehicula diam tempus. Nam ut sapien et mi congue tincidunt.
                                            Phasellus in ex neque. Aenean sed nunc sed elit facilisis finibus elit. Nunc vehicula nunc sit libero
                                        </p>
                                    </div>
                                    <div className="terms-box">
                                        <h5 className="h5-xl">11. Claims Of Copyright Infringement</h5>
                                ...
                                <aside id="sidebar" className="col-md-4">
                                    <div className="pl-60">
                                        <div id="search-field" className="sidebar-div mb-50">
                                            <div className="input-group mb-3">
                                                ...
                                                <div className="input-group-append">
                                                    <button className="btn" type="button"><i className="fa fa-search" aria-hidden="true" /></button>
                                                </div>
                                            </div>
                                        </div>
                                        <div id="text-widget" className="sidebar-div b-bottom pb-50 mb-50">
                                            <h5 className="h5-sm">About TebSocial</h5>
                                            <p>Mauris id class aptent taciti nostra, eget gravida donec enim ipsum a porta justo integer
                                                at velna auctor vitae magna, vitae suscipit mauris purus in magna
                                            </p>
                                            <a href="#" className="btn btn-sm btn-tra-grey primary-color-hover mt-15">Get Started</a>
                                        </div>
                                            ...
                                            <ul className="popular-posts">
                                                <li className="clearfix d-flex align-items-center">
                                                    ...
                                                    <div className="post-summary">
                                                        <a href="/single-post" className="rose-hover">Etiam sapien accumsan molestie ante empor ...</a>
                                                        <p>43 Comments</p>
                                                    </div>
                                                </li>
                                                <li className="clearfix d-flex align-items-center">
                                                    ...
                                                    <div className="post-summary">
                                                        <a href="/single-post" className="rose-hover">Blandit tempor sapien ipsum, porta justo ...</a>
                                                        <p>38 Comments</p>
                                                    </div>
                                                </li>
                                                <li className="clearfix d-flex align-items-center">
                                                    ...
                                                    <div className="post-summary">
                                                        <a href="/single-post" className="rose-hover">Cursus risus laoreet turpis auctor varius ...</a>
                                                        <p>29 Comments</p>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div id="popular-tags" className="sidebar-div b-bottom pb-50 mb-50">
                                            ...
                                            <span className="badge"><a href="#">Business</a></span>
                                            <span className="badge"><a href="#">Web Design</a></span>
                                            <span className="badge"><a href="#">Network</a></span>
                                            <span className="badge"><a href="#">Development</a></span>
                                            <span className="badge"><a href="#">Gallery</a></span>
                                            <span className="badge"><a href="#">Graphics</a></span>
                                            <span className="badge"><a href="#">Typography</a></span>
                                            <span className="badge"><a href="#">Journal</a></span>
                                            <span className="badge"><a href="#">Photoshop</a></span>
                                        </div>
                                        <div id="image-widget" className="sidebar-div mb-40">
