...
export default function SinglePost() {
    return (
        <>
            <Layout headerStyle={1} footerStyle={2} headerCls="navbar-light bg-light">
                        ...
                        <div className="row">
                            <div className="col-lg-10 offset-lg-1">
                                <div className="single-post-title mb-35 text-center">
                                    ...
                                    <h3 className="h3-md">Egestas volute nemo ipsam and turpis quaerat sodales a sapien landit</h3>
                                    ...
                                    <div className="post-inner-img">
                                        <div className="row d-flex align-items-center">
                                            ...
                                            <div className="col-md-6">
                                                ...
                                                <p>Graphic Designer, TebSocial</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="row">
                            <div className="col-lg-10 offset-lg-1">
                                <div className="cta-txt text-center">
                                    <h3 className="h3-xs">Create better experiences with TebSocial</h3>
