export default function Content7_10() {
    return (
        <>
                        ...
                        <div className="col-md-6 col-xl-6">
                            <div className="txt-block pc-30 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div className="cbox-1">
                                    <i className="fas fa-circle" />
                                    <div className="cbox-1-txt grey-color">
                                        <p>Gravida donec pretium and ipsum porta justo integer at velna vitae auctor integer
                                            congue a magna ipsum purus pretium ligula rutrum luctus ultrice. Aliquam a augue
                                            suscipit, luctus
                                        </p>
                                    </div>
                                </div>
