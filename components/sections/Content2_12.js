export default function Content2_12() {
    return (
        <>
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6">
                            <div className="txt-block pc-30 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <h3 className="h3-md">Your payments are secure, every time</h3>
                                ...
                                <div className="cbox-1">
                                    <i className="fas fa-circle" />
                                    <div className="cbox-1-txt grey-color">
                                        <p>Tempor sapien gravida donec pretium and ipsum porta integer at velna vitae
                                            auctor integer congue a magna ipsum purus pretium ligula rutrum luctus ultrice.
